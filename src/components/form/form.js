...
const Schedule = () => {
    ...
    return (
        <form>
            ...
            <div><input type="text" placeholder="2 пара" onChange={onChangeMondaySecond} value={mondaySecond} /> <input type="text" placeholder="кабінет" onChange={onChangeMondaySecondCabinet} value={mondaySecondCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeMondaySecondTeacher} value={mondaySecondTeacher} /></div>
            <div><input type="text" placeholder="3 пара" onChange={onChangeMondayThird} value={mondayThird} /> <input type="text" placeholder="кабінет" onChange={onChangeMondayThirdCabinet} value={mondayThirdCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeMondayThirdTeacher} value={mondayThirdTeacher} /></div>
            <div><input type="text" placeholder="4 пара" onChange={onChangeMondayFourth} value={mondayFourth} /> <input type="text" placeholder="кабінет" onChange={onChangeMondayFourthCabinet} value={mondayFourthCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeMondayFourthTeacher} value={mondayFourthTeacher} /></div>
            <div><label>Вівторок</label></div>
            <div><input type="text" placeholder="1 пара" onChange={onChangeTuesdayFirst} value={TuesdayFirst} /> <input type="text" placeholder="кабінет" onChange={onChangeTuesdayFirstCabinet} value={TuesdayFirstCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeTuesdayFirstTeacher} value={TuesdayFirstTeacher} /></div>
            <div><input type="text" placeholder="2 пара" onChange={onChangeTuesdaySecond} value={TuesdaySecond} /> <input type="text" placeholder="кабінет" onChange={onChangeTuesdaySecondCabinet} value={TuesdaySecondCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeTuesdaySecondTeacher} value={TuesdaySecondTeacher} /></div>
            <div><input type="text" placeholder="3 пара" onChange={onChangeTuesdayThird} value={TuesdayThird} /> <input type="text" placeholder="кабінет" onChange={onChangeTuesdayThirdCabinet} value={TuesdayThirdCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeTuesdayThirdTeacher} value={TuesdayThirdTeacher} /></div>
            <div><input type="text" placeholder="4 пара" onChange={onChangeTuesdayFourth} value={TuesdayFourth} /> <input type="text" placeholder="кабінет" onChange={onChangeTuesdayFourthCabinet} value={TuesdayFourthCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeTuesdayFourthTeacher} value={TuesdayFourthTeacher} /></div>
            <div><label>Середа</label></div>
            <div><input type="text" placeholder="1 пара" onChange={onChangeWednesdayFirst} value={WednesdayFirst} /> <input type="text" placeholder="кабінет" onChange={onChangeWednesdayFirstCabinet} value={WednesdayFirstCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeWednesdayFirstTeacher} value={WednesdayFirstTeacher} /></div>
            <div><input type="text" placeholder="2 пара" onChange={onChangeWednesdaySecond} value={WednesdaySecond} /> <input type="text" placeholder="кабінет" onChange={onChangeWednesdaySecondCabinet} value={WednesdaySecondCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeWednesdaySecondTeacher} value={WednesdaySecondTeacher} /></div>
            <div><input type="text" placeholder="3 пара" onChange={onChangeWednesdayThird} value={WednesdayThird} /> <input type="text" placeholder="кабінет" onChange={onChangeWednesdayThirdCabinet} value={WednesdayThirdCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeWednesdayThirdTeacher} value={WednesdayThirdTeacher} /></div>
            <div><input type="text" placeholder="4 пара" onChange={onChangeWednesdayFourth} value={WednesdayFourth} /> <input type="text" placeholder="кабінет" onChange={onChangeWednesdayFourthCabinet} value={WednesdayFourthCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeWednesdayFourthTeacher} value={WednesdayFourthTeacher} /></div>
            <div><label>Четвер</label></div>
            <div><input type="text" placeholder="1 пара" onChange={onChangeThursdayFirst} value={ThursdayFirst} /> <input type="text" placeholder="кабінет" onChange={onChangeThursdayFirstCabinet} value={ThursdayFirstCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeThursdayFirstTeacher} value={ThursdayFirstTeacher} /></div>
            <div><input type="text" placeholder="2 пара" onChange={onChangeThursdaySecond} value={ThursdaySecond} /> <input type="text" placeholder="кабінет" onChange={onChangeThursdaySecondCabinet} value={ThursdaySecondCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeThursdaySecondTeacher} value={ThursdaySecondTeacher} /></div>
            <div><input type="text" placeholder="3 пара" onChange={onChangeThursdayThird} value={ThursdayThird} /> <input type="text" placeholder="кабінет" onChange={onChangeThursdayThirdCabinet} value={ThursdayThirdCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeThursdayThirdTeacher} value={ThursdayThirdTeacher} /></div>
            <div><input type="text" placeholder="4 пара" onChange={onChangeThursdayFourth} value={ThursdayFourth} /> <input type="text" placeholder="кабінет" onChange={onChangeThursdayFourthCabinet} value={ThursdayFourthCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeThursdayFourthTeacher} value={ThursdayFourthTeacher} /></div>
            <div><label>Пятниця</label></div>
            <div><input type="text" placeholder="1 пара" onChange={onChangeFridayFirst} value={FridayFirst} /> <input type="text" placeholder="кабінет" onChange={onChangeFridayFirstCabinet} value={FridayFirstCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeFridayFirstTeacher} value={FridayFirstTeacher} /></div>
            <div><input type="text" placeholder="2 пара" onChange={onChangeFridaySecond} value={FridaySecond} /> <input type="text" placeholder="кабінет" onChange={onChangeFridaySecondCabinet} value={FridaySecondCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeFridaySecondTeacher} value={FridaySecondTeacher} /></div>
            <div><input type="text" placeholder="3 пара" onChange={onChangeFridayThird} value={FridayThird} /> <input type="text" placeholder="кабінет" onChange={onChangeFridayThirdCabinet} value={FridayThirdCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeFridayThirdTeacher} value={FridayThirdTeacher} /></div>
            <div><input type="text" placeholder="4 пара" onChange={onChangeFridayFourth} value={FridayFourth} /> <input type="text" placeholder="кабінет" onChange={onChangeFridayFourthCabinet} value={FridayFourthCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeFridayFourthTeacher} value={FridayFourthTeacher} /></div>
        </form>
    )
}
