...
const Schedule = () => {
    ...
    return (
        <form>
            ...
            <div>понеділок</div>
            <div><input type="text" placeholder="1 пара" onChange={onChangeMondayFirst} value={mondayFirst} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeMondayFirstCabinet} value={mondayFirstCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeMondayFirstTeacher} value={mondayFirstTeacher} /></div>
            <input type="text" placeholder="2 пара" onChange={onChangeMondaySecond} value={mondaySecond} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeMondaySecondCabinet} value={mondaySecondCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeMondaySecondTeacher} value={mondaySecondTeacher} />
            <input type="text" placeholder="3 пара" onChange={onChangeMondayThird} value={mondayThird} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeMondayThirdCabinet} value={mondayThirdCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeMondayThirdTeacher} value={mondayThirdTeacher} />
            <input type="text" placeholder="4 пара" onChange={onChangeMondayFourth} value={mondayFourth} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeMondayFourthCabinet} value={mondayFourthCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeMondayFourthTeacher} value={mondayFourthTeacher} />
            <label>Вівторок</label>
            <input type="text" placeholder="1 пара" onChange={onChangeTuesdayFirst} value={TuesdayFirst} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeTuesdayFirstCabinet} value={TuesdayFirstCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeTuesdayFirstTeacher} value={TuesdayFirstTeacher} />
            <input type="text" placeholder="2 пара" onChange={onChangeTuesdaySecond} value={TuesdaySecond} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeTuesdaySecondCabinet} value={TuesdaySecondCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeTuesdaySecondTeacher} value={TuesdaySecondTeacher} />
            <input type="text" placeholder="3 пара" onChange={onChangeTuesdayThird} value={TuesdayThird} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeTuesdayThirdCabinet} value={TuesdayThirdCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeTuesdayThirdTeacher} value={TuesdayThirdTeacher} />
            <input type="text" placeholder="4 пара" onChange={onChangeTuesdayFourth} value={TuesdayFourth} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeTuesdayFourthCabinet} value={TuesdayFourthCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeTuesdayFourthTeacher} value={TuesdayFourthTeacher} />
            <label>Середа</label>
            <input type="text" placeholder="1 пара" onChange={onChangeWednesdayFirst} value={WednesdayFirst} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeWednesdayFirstCabinet} value={WednesdayFirstCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeWednesdayFirstTeacher} value={WednesdayFirstTeacher} />
            <input type="text" placeholder="2 пара" onChange={onChangeWednesdaySecond} value={WednesdaySecond} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeWednesdaySecondCabinet} value={WednesdaySecondCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeWednesdaySecondTeacher} value={WednesdaySecondTeacher} />
            <input type="text" placeholder="3 пара" onChange={onChangeWednesdayThird} value={WednesdayThird} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeWednesdayThirdCabinet} value={WednesdayThirdCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeWednesdayThirdTeacher} value={WednesdayThirdTeacher} />
            <input type="text" placeholder="4 пара" onChange={onChangeWednesdayFourth} value={WednesdayFourth} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeWednesdayFourthCabinet} value={WednesdayFourthCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeWednesdayFourthTeacher} value={WednesdayFourthTeacher} />
            <label>Четвер</label>
            <input type="text" placeholder="1 пара" onChange={onChangeThursdayFirst} value={ThursdayFirst} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeThursdayFirstCabinet} value={ThursdayFirstCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeThursdayFirstTeacher} value={ThursdayFirstTeacher} />
            <input type="text" placeholder="2 пара" onChange={onChangeThursdaySecond} value={ThursdaySecond} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeThursdaySecondCabinet} value={ThursdaySecondCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeThursdaySecondTeacher} value={ThursdaySecondTeacher} />
            <input type="text" placeholder="3 пара" onChange={onChangeThursdayThird} value={ThursdayThird} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeThursdayThirdCabinet} value={ThursdayThirdCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeThursdayThirdTeacher} value={ThursdayThirdTeacher} />
            <input type="text" placeholder="4 пара" onChange={onChangeThursdayFourth} value={ThursdayFourth} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeThursdayFourthCabinet} value={ThursdayFourthCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeThursdayFourthTeacher} value={ThursdayFourthTeacher} />
            <label>Пятниця</label>
            <input type="text" placeholder="1 пара" onChange={onChangeFridayFirst} value={FridayFirst} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeFridayFirstCabinet} value={FridayFirstCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeFridayFirstTeacher} value={FridayFirstTeacher} />
            <input type="text" placeholder="2 пара" onChange={onChangeFridaySecond} value={FridaySecond} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeFridaySecondCabinet} value={FridaySecondCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeFridaySecondTeacher} value={FridaySecondTeacher} />
            <input type="text" placeholder="3 пара" onChange={onChangeFridayThird} value={FridayThird} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeFridayThirdCabinet} value={FridayThirdCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeFridayThirdTeacher} value={FridayThirdTeacher} />
            <input type="text" placeholder="4 пара" onChange={onChangeFridayFourth} value={FridayFourth} /> <input style={style.cabinet} type="text" placeholder="кабінет" onChange={onChangeFridayFourthCabinet} value={FridayFourthCabinet} /> <input type="text" placeholder="викладач" onChange={onChangeFridayFourthTeacher} value={FridayFourthTeacher} />
        </form>
    )
}
